...
(defun epoxide-odl-get-flow-stats (dpid host username password)
  "Query flow statistics of DPID from an OpenDaylight controller.

The controller should be running at HOST.  Use USERNAME and
...
(defun epoxide-odl-json-insert-flowstat (dpid json to-buffer)
  "Process json formatted flowstat and insert to to a buffer.

Insert DPID to identify the datapath, JSON contains the object
for displaying, and the text is inserted into TO-BUFFER."
